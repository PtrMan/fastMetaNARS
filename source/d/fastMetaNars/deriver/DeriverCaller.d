...
TemporaryDerivedTerm*[] deriverCaller(ReasonerInstance reasonerInstance, UnifiedTermIndex premiseLeftIndex, UnifiedTermIndex premiseRightIndex, out TemporaryDerivedCompoundWithDecorationAndTruth*[] derivedCompoundTermsWithDecorationAndTruth, bool insert = true) {
	...
	*/
	...
	if( insert ) {
		...
		derivedCompoundTermsWithDecorationAndTruth = insertDerivedCompoundTermsAndReturnDerivedCompoundTermsWithDecoration(reasonerInstance, filteredTerms.array);
	}

	return filteredTerms.array;
}

TemporaryDerivedCompoundWithDecorationAndTruth*[] insertDerivedCompoundTermsAndReturnDerivedCompoundTermsWithDecoration(ReasonerInstance reasonerInstance, TemporaryDerivedTerm*[] derivedCompoundTerms) {
	TemporaryDerivedCompoundWithDecorationAndTruth*[] derivedCompoundTermsWithDecorationAndTruth;

	foreach( TemporaryDerivedTerm *iterationDerivedCompoundTerm; derivedCompoundTerms ) {
		TemporaryDerivedCompoundWithDecorationAndTruth *newDerivedCompoundTermWithDecorationAndTruth = new TemporaryDerivedCompoundWithDecorationAndTruth;
		...
		derivedCompoundTermsWithDecorationAndTruth ~= newDerivedCompoundTermWithDecorationAndTruth;
	}

	foreach( iterationDerivedCompoundTermWithDecorationAndTruth; derivedCompoundTermsWithDecorationAndTruth ) {
		insertDerivedCompoundTerm(reasonerInstance, iterationDerivedCompoundTermWithDecorationAndTruth.derivedCompoundWithDecoration);
	}
